...
**Fail:** Any of the above patterns present (see [editorial-edit-patterns.md](editorial-edit-patterns.md) for the full taxonomy of twelve patterns; this eval covers the binary-checkable subset).
