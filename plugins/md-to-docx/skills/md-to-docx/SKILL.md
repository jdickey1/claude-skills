...
version: 1.0.0
effort: low
expires_when: "Claude runs pandoc with correct standalone/frontmatter flags and resolves image paths first try, verifying output unprompted — whole skill retires, no durable remainder (no template or format contract to keep)"
---
